...
class MainView(View, customtkinter.CTk):
    ...
    def edit(self):
        ...
        self.subject_cb['values'] = ["Rüherei", "Spiegelei", "Hartgekochte Rüherei", "Rüherei", "Spiegelei", "weichgekochte Ei"]
        ...
        self.stop = customtkinter.CTkButton(self.editwindow, text="Abbrechen", text_color="Black", command=self.on_closing).grid(row=7, column=1, columnspan=1, pady=10, padx=20, sticky="nesw")
    ...
    def create(self):
        ...
        self.createsubjectbutton = customtkinter.CTkButton(master=self.frame_input, text="Fachbereich erstellen/löschen", fg_color="#38FF88", text_color="Black", width=30, command=self.createsubject).grid(row=0, column=10, columnspan=1, pady=20, padx=40, sticky="nesw")
        self.titleheading=customtkinter.CTkLabel(master=self.frame_input,anchor=tkinter.W, justify=tkinter.LEFT, text="Titel erstellen:", text_font='Corbel 17 bold').grid(row=0, column=0, columnspan=2, pady=20, padx=20, sticky="w")
    ...
    def createsubject(self):
        ...
        self.subjectwindow.geometry('1000x305')
        ...
        self.createtitle=customtkinter.CTkLabel(master=self.frame_input1,anchor=tkinter.W, justify=tkinter.LEFT, text="Erstellen:", text_font='Arial 13').grid(row=0, column=0, columnspan=1, pady=10, padx=10, sticky="w")
        self.titleentry = customtkinter.CTkEntry(master=self.frame_input1, width=775)
        self.titleentry.grid(row=1, column=0, columnspan=3, pady=10, padx=10, sticky="nesw")
        self.createbut = customtkinter.CTkButton(master=self.frame_input1, text="Fachbereich erstellen", fg_color="#38FF88", text_color="Black", width=10).grid(row=1, column=4, columnspan=1, pady=10, padx=10, sticky="nesw")
        ...
        self.subject_cb1.grid(row=3, column=0, columnspan=3, pady=10, padx=10, sticky="nesw")
        self.subject_cb1['state'] = 'readonly'
        self.subject_cb1['values'] = ["Rüherei", "Spiegelei", "Hartgekochte Rüherei", "Rüherei", "Spiegelei", "weichgekochte Ei"]
        self.createbut = customtkinter.CTkButton(master=self.frame_input1, text="Fachbereich löschen", fg_color="#38FF88", text_color="Black").grid(row=3, column=4, columnspan=1, pady=10, padx=10, sticky="nesw")

        self.finish = customtkinter.CTkButton(self.subjectwindow, text="Fertig", fg_color="#38FF88", text_color="Black").grid(row=7, column=2, columnspan=1, pady=10, padx=20, sticky="nesw")
        self.stop = customtkinter.CTkButton(self.subjectwindow, text="Abbrechen", text_color="Black", command=self.on_closing2).grid(row=7, column=1, columnspan=1, pady=10, padx=20, sticky="nesw")
